...
Les prix des options asiatiques ont été trouvés à l'aide de la fonction `AsianOption` du paquetage `RQuantLib`. Le prix de l'option d'achat arithmétique avec un prix d'exercice de 110\$ est `r round(call_asia, 2)`\$. Le pris de l'option de vente à barrière désactivante de 105\$ est `r round(put_asia, 2)`\$. Le prix d'exercice est 95\$ pour cette option.
