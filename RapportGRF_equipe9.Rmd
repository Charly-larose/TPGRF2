...
```
\begin{center}
\textsf{Figure 6 : Modèle Black-Scholes et modèle arbre binomial pour une option d'achat européenne}
\end{center}
...
```
\begin{center}
\textsf{Figure 7 : Modèle Black-Scholes et modèle arbre binomial pour une option de vente européenne}
\end{center}
...
\begin{center}
\textsf{Figure 8 : Coût de l'option d'achat européenne avec le modèle Black-Scholes en fonction du prix}
\end{center}
...
```
\begin{center}
\textsf{Figure 9 : Coût de l'option de vente européenne avec le modèle Black-Scholes en fonction du prix}
\end{center}
